...
// Build user-set functionality captured from INPUT elements on INDEX, return relevant ordered object, calculate and display user order entries and price for unique item set.
...
// Calculate total, and total number of items, return price or discount 10% if user has selected more than 4 unique items.
