...
class Extras {
    ...
    public function echoExtrasType() {
        echo "<h2>You have ordered the ".$this->extrasType." which contains:</h2> </br>";
    }

    public function echoCola() {
        $this->pixelCola = "<h3>A 500ml cup of our own-brand poppin' Pixel Cola!</h3> </br>";
        echo $this->pixelCola;
    }

    public function echoOrange() {
        $this->pixelOrange = "<h3>A 500ml cup of our hand-fizzed Pixel Orange!</h3> </br>";
        echo $this->pixelOrange;
    }

    public function echoIceCream() {
        $this->pixelIceCream = "<h3>A pint of our Iced, then de-iced, then re-iced Pixel Ice Cream, that's double Iced!</h3> </br>";
        echo $this->pixelIceCream;
    }

    public function echoCookies() {
        $this->pixelCookies = "<h3>A portion of our gooey chooey kablooey Pixel Cookies!</h3> </br>";
